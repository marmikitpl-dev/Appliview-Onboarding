...
//             {/* Replace this Building icon with your company logo */}
...
//             <button
//               type="submit"
//               className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-4 rounded-lg hover:from-blue-700 hover:to-indigo-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200 font-medium transform hover:scale-[1.02] active:scale-[0.98]"
//             >
//               Sign In
//             </button>
//           </form>
...
//             <div className="text-center">
//               <p className="text-sm text-gray-500 mb-3">Demo credentials for testing:</p>
//               <div className="bg-gray-50 rounded-lg p-3 text-left">
//                 <p className="text-xs text-gray-600 font-mono">Email: candidate@example.com</p>
//                 <p className="text-xs text-gray-600 font-mono">Password: password</p>
//               </div>
//             </div>
//           </div>
